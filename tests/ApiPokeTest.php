 ...
 */
class ApiPokeTest extends BaseTestCase
{
    /**
     * 為了測試所需要的分站編號
     */
    ...
    public function testGetAllBetPassportThroughBridgeAction()
    {
        ...
        try {
            ...
            // act
            $allBetResponse = ApiPoke::poke($this->allBetStation, $bridgeAction, $allBetParams);
    ...
    public function testGetBingoPassportThroughBridgeAction()
    {
        ...
        try {
            ...
            // act
            $bingoResponse = ApiPoke::poke($this->bingoStation, $bridgeAction, $bingoParams);
    ...
    public function testGetMayaPassportThroughBridgeAction()
    {
        ...
        try {
            ...
            // act
            $mayaResponse = ApiPoke::poke($this->mayaStation, $bridgeAction, $mayaParams);
    ...
    public function testGetSaGamingPassportThroughBridgeAction()
    {
        ...
        try {
            ...
            // act
            $saGamingResponse = ApiPoke::poke($this->saGamingStation, $bridgeAction, $saGamingParams);
    ...
    public function testGetSuperSportPassportThroughBridgeAction()
    {
        ...
        try {
            ...
            // act
            $superSportResponse = ApiPoke::poke($this->superSportStation, $bridgeAction, $superSportParams);
