...
class NineKLottery2CallerTest extends BaseTestCase
{
    /**
     * 測試帳號
     *
    ...
    public function setUp()
    {
        ...
        $this->testAccount = config('api_caller.nine_k_lottery_2.config.test_member_account');
        $this->testPassword = config('api_caller.nine_k_lottery_2.config.test_member_password');

        // 提示測試中的 caller 是哪一個
        $this->console->write('9k Lottery 2');
    }
    ...
    public function testRegisterUser()
    {
        ...
        try {
            ...
            $agentId = config('api_caller.nine_k_lottery_2.config.agent_id');

            // Act
            $response = ApiCaller::make('nine_k_lottery_2')->methodAction('post', 'RegisterUser', [
                // 路由參數這邊設定
            ])->params([
                // 一般參數這邊設定
                'BossID' => $agentId,
    ...
    public function testGetUserBalance()
    {
        ...
        try {
            ...
            // Act
            $response = ApiCaller::make('nine_k_lottery_2')->methodAction('post', 'GetUserBalance', [
                // 路由參數這邊設定
            ])->params([
                // 一般參數這邊設定
                'MemberAccount' => $this->testAccount,
    ...
    public function testBalanceTransfer()
    {
        ...
        try {
            ...
            // Act
            $response = ApiCaller::make('nine_k_lottery_2')->methodAction('post', 'BalanceTransfer', [
                // 路由參數這邊設定
            ])->params([
                // 一般參數這邊設定
                'MemberAccount' => $this->testAccount,
    ...
    public function testCheckTransfer()
    {
        ...
        try {
            ...
            // Act
            $balanceTransferResponse = ApiCaller::make('nine_k_lottery_2')->methodAction('post', 'BalanceTransfer', [
                // 路由參數這邊設定
            ])->params([
                // 一般參數這邊設定
                'MemberAccount' => $this->testAccount,
            ...
            $checkTransferResponse = ApiCaller::make('nine_k_lottery_2')->methodAction('post', 'CheckTransfer', [
                // 路由參數這邊設定
            ])->params([
                // 一般參數這邊設定
                'MemberAccount' => $this->testAccount,
    ...
    public function testUserLogin()
    {
        ...
        try {
            ...
            // Act
            $response = ApiCaller::make('nine_k_lottery_2')->methodAction('post', 'UserLogin', [
                // 路由參數這邊設定
            ])->params([
                // 一般參數這邊設定
                'MemberAccount' => $this->testAccount,
    ...
    public function testBetList()
    {
        ...
        try {
            ...
            // Act
            $response = ApiCaller::make('nine_k_lottery_2')->methodAction('post', 'BetList', [
                // 路由參數這邊設定
            ])->params([
                // 一般參數這邊設定
